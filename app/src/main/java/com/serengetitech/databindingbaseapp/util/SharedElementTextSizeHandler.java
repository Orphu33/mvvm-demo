package com.serengetitech.databindingbaseapp.util;
...
public class SharedElementTextSizeHandler extends SharedElementCallback {
    ...
    public SharedElementTextSizeHandler(Activity activity) {
